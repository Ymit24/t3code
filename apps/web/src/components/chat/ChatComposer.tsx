import { BotIcon, CircleAlertIcon, ListTodoIcon, LockIcon, LockOpenIcon, XIcon } from "lucide-react";
...
interface ChatComposerProps {
  controller: ReturnType<typeof useChatComposerController>;
  isGitRepo: boolean;
}
...
export function ChatComposer({ controller, isGitRepo }: ChatComposerProps) {
  const {
    ...
    selectedProvider,
    setExpandedImageFromComposerImageId,
                  ...
                  >
                    {image.previewUrl ? (
                      <button
                        ...
                        onClick={() => {
                          setExpandedImageFromComposerImageId(image.id);
                        }}
                      >
                        <img
              ...
              <div data-chat-composer-actions="right" className="flex shrink-0 items-center gap-2">
                ...
                {activePendingProgress ? (
                  ...
                  <button
                    ...
                    disabled={isSendBusy || isConnecting || (!prompt.trim() && composerImages.length === 0)}
                    aria-label={
                      isConnecting
                        ? "Connecting"
                        : isPreparingWorktree
